#!/usr/bin/env python3
"""
TROJAN5: Life Cycle Controller State Manipulation Automation Script

This script generates trojan5 - Life Cycle Controller State Manipulation.
This is the Python script version of trojan5_automation.ipynb
"""
...
def main():
    """Main function for generating Trojan 5"""
    print("=" * 80)
    print("TROJAN5: Life Cycle Controller State Manipulation")
    print("=" * 80)
    print()
    ...
    # Generate trojan5
    rtl_path = "hw/ip/lc_ctrl/rtl/lc_ctrl_fsm.sv"
...
- Original state machine must work until trigger""",
    ...
    # Save modified RTL
    output_dir = os.path.join(base_dir, "trojan5", "rtl")
    ...
    ai_dir = os.path.join(base_dir, "trojan5", "ai")
