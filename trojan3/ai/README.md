# AI Interaction Logs - Trojan 3

This directory contains all AI interaction logs for Trojan 3 (AES Key Leakage).
...
- `trojan3_YYYYMMDD_HHMMSS.json` - Individual interaction logs
- `README.md` - This file
...
# View a specific log
cat trojan3_20241108_120000.json | jq .

# Extract just the response
cat trojan3_20241108_120000.json | jq .response
```
