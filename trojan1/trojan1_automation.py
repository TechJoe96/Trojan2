#!/usr/bin/env python3
"""
TROJAN1: AES Key Leakage Trojan Automation Script

This script generates trojan1 - AES Key Leakage Trojan.
This is the Python script version of trojan1_automation.ipynb
"""
...
def main():
    """Main function for generating Trojan 1"""
    print("=" * 80)
    print("TROJAN1: AES Key Leakage Trojan")
    print("=" * 80)
    print()
    ...
    # For GPT-4.1, use "gpt-4-turbo" or "gpt-4o" (not "gpt-4.1")
    ...
    # Generate trojan1
    rtl_path = "hw/ip/aes/rtl/aes_core.sv"
    ...
    try:
        ...
        print(f"  This is expected if OpenTitan is not cloned yet.")
...
- Must maintain performance characteristics""",
    ...
    # Save modified RTL
    output_dir = os.path.join(base_dir, "trojan1", "rtl")
    ...
    ai_dir = os.path.join(base_dir, "trojan1", "ai")
