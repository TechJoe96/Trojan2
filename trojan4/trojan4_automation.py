#!/usr/bin/env python3
"""
TROJAN4: HMAC Integrity Check Bypass Automation Script

This script generates trojan4 - HMAC Integrity Check Bypass.
This is the Python script version of trojan4_automation.ipynb
"""
...
def main():
    """Main function for generating Trojan 4"""
    print("=" * 80)
    print("TROJAN4: HMAC Integrity Check Bypass")
    print("=" * 80)
    print()
    ...
    # Generate trojan4
    rtl_path = "hw/ip/hmac/rtl/hmac_core.sv"
...
- Original HMAC must work until trigger""",
    ...
    # Save modified RTL
    output_dir = os.path.join(base_dir, "trojan4", "rtl")
    ...
    ai_dir = os.path.join(base_dir, "trojan4", "ai")
