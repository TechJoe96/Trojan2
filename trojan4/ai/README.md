# AI Interaction Logs - Trojan 4

This directory contains all AI interaction logs for Trojan 4 (AES Key Leakage).
...
- `trojan4_YYYYMMDD_HHMMSS.json` - Individual interaction logs
- `README.md` - This file
...
# View a specific log
cat trojan4_20241108_120000.json | jq .

# Extract just the response
cat trojan4_20241108_120000.json | jq .response
```
